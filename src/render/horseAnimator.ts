...
export class HorseAnimator {
  ...
  private drawEnvironment(t: number, w: number, h: number): void {
    ...
    this.ctx.fillStyle = 'rgba(56, 116, 56, 0.42)';
  ...
  render(timeMs: number, mood: HorseMood, rules: DanceRules): void {
    ...
    this.ctx.clearRect(-2, -2, w + 4, h + 4);
    this.drawEnvironment(t, w, h);
